        ...
        <div>
            ...
            <div className='p-9 flex flex-wrap justify-center items-center '>
                ...
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img1} />
                    <p className=''>cambridge university</p>
                </div>
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img2} />
                    <p>california university</p>
                </div>
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img3} />
                    <p>university of Edinburg</p>
                </div>
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img4} />
                    <p>Havard university</p>
                </div>
                <div className=' m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img5} />
                    <p>Hopkins university</p>
                </div>
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img6} />
                    <p>Humboldt university</p>
                </div>
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img7} />
                    <p>Max Planck university</p>
                </div>
                <div className='m-4 h-[200px] w-[300px] bg-blue-100'>
                    <img className='h-full w-full hover:opacity-75' src={img8} />
